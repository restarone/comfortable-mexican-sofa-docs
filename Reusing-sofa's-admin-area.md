...
From your views you can use `cms_form_for` method to re-use Sofa's FormBuilder. There are also some existing styles for tables, will\_paginate helpers, etc. Take a look in [app/assets/stylesheets/comfortable_mexican_sofa/content.css](../blob/master/app/assets/stylesheets/comfortable_mexican_sofa/content.css)
